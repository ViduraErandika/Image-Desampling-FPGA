...
set rc [catch {
  ...
  add_files -quiet D:/FPGA_Development/Image-Desampling-FPGA/ModuleTestBenches/TempProject.runs/synth_1/TopModule.dcp
  link_design -top TopModule -part xc7k70tfbv676-1
